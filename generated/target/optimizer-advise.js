...
exports.adviseOptimizer = adviseOptimizer;
exports.adviceAsDiagnostics = adviceAsDiagnostics;
const diagnostics_js_1 = require("./diagnostics.js");
function adviseOptimizer(source, fileName) {
    ...
    void fileName;
    void diagnostics_js_1.lineColAt;
    return advice;
}
function adviceAsDiagnostics(advice, fileName) {
    return advice.map((a) => ({

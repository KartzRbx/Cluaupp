...
After every edit run `cluaupp build`. If it fails, fix the source and build again. Do not leave unused-parameter, type, or include errors visible. Open the matching `out/**/*.luau` and confirm `require` paths and `:` method calls.

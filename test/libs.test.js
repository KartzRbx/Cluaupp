...
const checks = [
	...
	"type Net = Net.Net",
	"const MathUtils = require(ReplicatedStorage.CluauppLibs.MathUtils)",
	"const FormatNumber = require(ReplicatedStorage.CluauppLibs.FormatNumber)",
	"const Module3D = require(ReplicatedStorage.CluauppLibs.Module3D)",
	"const Promise = require(ReplicatedStorage.CluauppLibs.Promise)",
	"type Promise = Promise.Promise",
	"const Twinkle = require(ReplicatedStorage.CluauppLibs.Twinkle)",
	"const function OnCoins(",
	"const function init()",
	"Janitor.new()",
	"janitor:Add(",
	"janitor:Cleanup()",

...
const CLIENT_PATTERNS: Array<{ code: string; re: RegExp; message: string }> = [
...
const SERVER_PATTERNS: Array<{ code: string; re: RegExp; message: string }> = [
...
export function checkSecurity(source: string, fileName: string): PlatformDiagnostic[] {
